    ...
    class temps
    {
        ...
        private static void convertTemp(char type, int numToConvert)
        {
            ...
            if (type== 'F')
            {
                ...
                Console.WriteLine($"{numToConvert} degrees celcius converted to fahrenheit is {convertedValue}");
            }
            else
            {
                convertedValue = (numToConvert - 32) * 5/9;
                Console.WriteLine($"{numToConvert} degrees fahrenheit converted to celcius is {convertedValue}");
            }
        }
